...
extension Movie {
    ...
    ///    - `static` means this property is a "Type Property" (i.e. associated with the Movie "type", not any particular movie instance)
    ...
    static func getFavoriteMovies(forKey key: String) -> [Movie] {
        // 1.
        let defaults = UserDefaults.standard
    ...
    func addToFavorites() {
        // 1.
        var favoriteMovies = Movie.getFavoriteMovies(forKey: Movie.favoritesKey)
